...
public class Book extends javax.swing.JFrame {
    ...
    public void SetValues(){
        ...
        if(BookDate.equals("(-none-)")){
            try {
                ...
                ResultSetObj = StatementObj.executeQuery("SELECT COUNT(Train_no) FROM Trains WHERE from_id = '" + GetStation(this.Source) + "' AND to_id = '" + GetStation(this.Destination) + "'");
                ResultSetObj.next();
                int rowCount = Integer.parseInt(ResultSetObj.getString(1));
                String[] listData;
                ResultSetObj = StatementObj.executeQuery("SELECT * FROM Trains WHERE from_id = '" + GetStation(this.Source) + "' AND to_id = '" + GetStation(this.Destination) + "'");
                if(rowCount == 0){
                    listData = new String[1];
                    listData[0] = "No trains running for entered stations.";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jList1.getSelectedIndex() == -1){
        ...
        else if(this.Selection.equals("No trains running for entered stations.")){
            ...
            JOptionPane.showMessageDialog(null, "Go back and select a date for the available trains.", "Select journey date", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            this.setVisible(false);
